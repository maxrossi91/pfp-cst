...
//     for (size_t i = 2345; i < 2355; ++i)
//         std::cout << pf_cst->pfp.lcp_M[i] << " ";
//     std::cout << std::endl;

//     for (size_t i = 2362; i < 2370; ++i)
//         std::cout << pf_cst->lcp(i) << " ";
//     std::cout << std::endl;
...
//     size_t n = sdsl_cst->size();
//     for (int i = 2362; i < n - 1; ++i) // It starts from 2, since the first suffix has the 0 in sdsl that is different from #
//     {
